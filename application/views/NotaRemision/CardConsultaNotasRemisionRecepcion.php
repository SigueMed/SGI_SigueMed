                            ...
                            <div class="row">
                              <div class="col-md-8 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtPaciente" placeholder="Buscar" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                              <div class="col-md-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtFolio" placeholder="Buscar" />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-1">
                                  <div class="form-group">
                                    <label style ="color:white">_</label>
                                    <button type="button" name="button" class="btn btn-info form-control icon-search" onclick="ConsultarNotasRemision()"></button>
...
<script>
    $(document).ready(function(){
     ...
     function ConsultarNotasRemision()
     {

       var CondicionesBusqueda;
       var Paciente = $("#txtPaciente").val();
       var NotaRemision= $("#txtFolio").val();

       if (Paciente !== "")
       {
         CondicionesBusqueda = "Nombre LIKE '%"+ Paciente + "%' OR Apellidos LIKE '%" + Paciente + "%'";
       }
       else {
         CondicionesBusqueda ="Folio = " + NotaRemision;
       }



       var datos ={
         CondicionesBusqueda : CondicionesBusqueda
       };
        CargarTabla(datos);
     ...
     function CargarTabla(datos)
     {
         ...
         var t = $('#tblNotasRemision').DataTable({
           "drawCallback": function( settings ) {
             ...
             "ajax":{
               url:"<?php echo site_url();?>/NotaRemision_Controller/BuscarNotasRemision",
               data:datos,
               method:"POST",
               dataSrc: ""
             },
