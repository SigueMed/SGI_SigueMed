      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="index.html" class="navbar-brand nav-link"><img alt="branding logo" src="<?php echo base_url();?>app-assets/images/logo/robust-logo-light.png" data-expand="<?php echo base_url();?>app-assets/images/logo/robust-logo-light.png" data-collapse="<?php echo base_url();?>app-assets/images/logo/robust-logo-small.png" class="brand-logo"></a></li>
    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href="#"><i class="icon-calendar5"></i><span data-i18n="nav.dash.main" class="menu-title">Agenda</span></a>
            <ul class="menu-content">
              <li><a href="<?php echo site_url();?>/Agenda/VistaAgenda" data-i18n="nav.dash.main" class="menu-item">Agenda</a>
              </li>
              <li><a href="<?php echo site_url();?>/Agenda/CitasHoy" data-i18n="nav.dash.main" class="menu-item">Citas del día</a>
              </li>
