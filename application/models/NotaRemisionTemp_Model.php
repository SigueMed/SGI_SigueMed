...
class NotaRemisionTemp_Model extends CI_Model {
    ...
    public function GuardarNotaRemisionTemp($NotaRemisionTemp)
    {
        ...
        try {
          ...
          message_log('ERROR','GuardarNotaRemisionTemp.Insert.error=' $e->getMessage());
          throw new Exception("Error al inertar nueva nota remision temporal", 1);
        }
